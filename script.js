...
import createRow from './modules/createModule.js';
import {renderGoods} from './modules/render.js';
import eventControl from './modules/eventControl.js';
import {getTotalSum} from './modules/calculationsModule.js';
...
]`;
{
  const init = () => {
    ...
    createRow(data, vendorCodeId);
    renderGoods(data, tableBody);
    const {closeModal} =
